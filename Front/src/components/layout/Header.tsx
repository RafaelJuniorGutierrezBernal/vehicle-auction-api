  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200 py-4 px-8">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold text-blue-600 ml-0">
          AutoDeal / Dealer Management
        </h1>
          ...
          {keycloak.authenticated ? (
            <>
              ...
              <button 
                ...
                className="bg-red-50 text-red-600 px-4 py-2 rounded-lg font-semibold hover:bg-red-700 hover:text-black transition-colors "
              >
                Cerrar Sesión
              </button>
            </>
